...
const StepTwo = ({ setTotal }) => {
  ...
  }, [arraySchedules, onPremisesSchedules, cloudStoreSchedules]);
              ...
              {arraySchedules.length > 0 && (
                <div>
                  ...
                  {arraySchedules.map((schedule, index) => (
                    <p key={index}>
                      {`${schedule.frequency} | Every ${schedule.backupFrequency.value} ${
                        schedule.backupFrequency.unit
                      } between ${schedule.timeRangeStart} to ${schedule.timeRangeEnd}, Retain For: ${
                        schedule.retainFor.value
